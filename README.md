...
- **[System Prompts (Russian)](SYSTEM_PROMPTS.md)** - Все промпты системы (на русском)
- **[System Prompts (English)](SYSTEM_PROMPTS_EN.md)** - All system prompts documentation
...
**Use AiLegalArmenia Platform**

Simply visit the [AiLegalArmenia Project](https://lovable.dev/projects/REPLACE_WITH_PROJECT_ID) and start prompting.
...
Simply open [AiLegalArmenia](https://lovable.dev/projects/REPLACE_WITH_PROJECT_ID) and click on Share -> Publish.

## Can I connect a custom domain to my AiLegalArmenia project?
